 ...
 */
@Local
public interface IUsuarioBeanLocal {
    ...
    boolean comprobarContrasenia(String password, UsuarioDTO usuarioDTO);

    void actualizar(UsuarioDTO u) throws EntityException;
}
