...
/**
 * Clase que representa la ventana de listado de tipos de intervención.
 */
public class JFListadoTipoIntervencion extends javax.swing.JFrame {
     ...
     */
    private static JFListadoTipoIntervencion instancia;
     ...
     */
    private JFListadoTipoIntervencion() {
        this.initComponents();
        this.limpiarFiltros();
        this.cargarComboBox();
        this.recargarFilas();
        this.cargarEventoSeleccion();
    }
     ...
     */
    public static JFListadoTipoIntervencion getInstancia() {
        if (instancia == null) {
            instancia = new JFListadoTipoIntervencion();
        }
        return instancia;
    }
    ...
    /**
     * Rellena una fila de la tabla con los datos de un tipo de intervención.<br>
     * Si la fila no existe, crea una nueva y la selecciona.
     *
     * @param tipo Tipo de intervención a cargar.
     * @param fila Fila a cargar.
     */
    public void cargarFila(TipoIntervencionDTO tipo, int fila) {
        // Obtiene el modelo de la tabla
        DefaultTableModel modelo = (DefaultTableModel) this.tblTiposDeIntervencion.getModel();

        // Si la fila no existe, crea una nueva
        if (modelo.getRowCount() <= fila) {
            modelo.addRow(new Object[]{});
            fila = modelo.getRowCount() - 1;
        }

        // Carga los datos del tipo de intervención en la fila
        modelo.setValueAt(tipo.getId(), fila, 0);
        modelo.setValueAt(tipo.getNombre(), fila, 1);
        modelo.setValueAt(tipo.getEstado(), fila, 2);
    }

    /**
     * Método que recarga las filas de la tabla con los tipos de intervención de la base de datos.
     */
    public void recargarFilas() {
        ...
        // Obtiene la lista completa de tipos de intervención
        List<TipoIntervencionDTO> tipos = Conexion.rec_tipoIntervencion.obtenerTodo();

        // Agrega cada tipo de intervención a la tabla
        for (TipoIntervencionDTO tip : tipos) {
            cargarFila(tip, modelo.getRowCount());
        }
    }
    ...
    public void aplicarFiltros() {
        ...
        this.tblTiposDeIntervencion.setRowSorter(sorter);
    ...
    /**
     * Método que carga los estados en el ComboBox.
     */
    public void cargarComboBox() {
        ...
        this.cbxEstado.addItem(EstadosEnum.ACTIVO.name());
        this.cbxEstado.addItem(EstadosEnum.ELIMINADO.name());
    }
    ...
    private void cargarEventoSeleccion() {
        ListSelectionModel model = this.tblTiposDeIntervencion.getSelectionModel();
        model.addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) { // Evita que se ejecute más de una vez
                if (this.tblTiposDeIntervencion.getSelectedRow() != -1) {
                    int filaSeleccionada = this.tblTiposDeIntervencion.getSelectedRow();
                    int id = (int) this.tblTiposDeIntervencion.getModel().getValueAt(this.tblTiposDeIntervencion.getRowSorter().convertRowIndexToModel(filaSeleccionada), 0);
                    TipoIntervencionDTO tip = Conexion.rec_tipoIntervencion.obtenerPorID(id);
    ...
    /**
     * Método que se ejecuta al hacer clic en el botón "Consultar".<br>
     * Recarga las filas de la tabla con los tipos de intervención que coincidan
    ...
    /**
     * Método que se ejecuta al hacer clic en el botón "Limpiar".<br>
    ...
    /**
     * Método que se ejecuta al hacer clic en el botón "Cancelar".<br>
    ...
    /**
     * Método que se ejecuta al hacer clic en el botón "Baja/Reactivar".<br>
     * Realiza la baja o reactivación de un tipo de intervención.
     *
     * @param evt Evento de clic en el botón.
     */
    private void btnBajaReactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBajaReactivarActionPerformed
        ...
        if ((respuesta == JOptionPane.YES_OPTION)) {
            ...
            if (tip.getEstado().equals(EstadosEnum.ACTIVO)) {
                ...
                Conexion.rec_tipoIntervencion.desactivar(id);
                this.btnBajaReactivar.setText("Reactivar");
                JOptionPane.showMessageDialog(this, "Tipo de Intervención: " + tip.getNombre() + " desactivada.");
            } else {
                tip.setEstado(EstadosEnum.ACTIVO);
                Conexion.rec_tipoIntervencion.activar(id);
                this.btnBajaReactivar.setText("Baja");
                JOptionPane.showMessageDialog(this, "Tipo de Intervención: " + tip.getNombre() + " activada.");
            }
    ...
    private void btnExportarExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarExcelActionPerformed
        try {
            ExcelManager.exportarExcel(tblTiposDeIntervencion);
    ...
    private void initComponents() {
        ...
        tblTiposDeIntervencion = new javax.swing.JTable();
        ...
        tblTiposDeIntervencion.setAutoCreateRowSorter(true);
        tblTiposDeIntervencion.setBackground(new java.awt.Color(217, 217, 217));
        tblTiposDeIntervencion.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblTiposDeIntervencion.setColumnSelectionAllowed(true);
        tblTiposDeIntervencion.setMinimumSize(new java.awt.Dimension(1007, 558));
        tblTiposDeIntervencion.setPreferredSize(new java.awt.Dimension(1007, 558));
        scrollPanelTabla.setViewportView(tblTiposDeIntervencion);
        tblTiposDeIntervencion.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);

        txtID.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        lblListadoDeUsuarios.setFont(new java.awt.Font("Unispace", 0, 36)); // NOI18N
        lblListadoDeUsuarios.setText("Listado de Tipo de Intervención");
        ...
        backgroundLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, backgroundLayout.createSequentialGroup()
                ...
                .addComponent(btnExportarExcel, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(backgroundLayout.createSequentialGroup()
                .addGap(115, 115, 115)
    ...
    private javax.swing.JTable tblTiposDeIntervencion;
