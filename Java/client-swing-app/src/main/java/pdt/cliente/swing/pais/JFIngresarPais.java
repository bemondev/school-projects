...
/**
 * Clase que representa la ventana de ingreso de país.
 */
public class JFIngresarPais extends javax.swing.JFrame {

    // ======================== Atributos ========================
    /**
     * Instancia única de la clase (patrón Singleton).
     */
    private static JFIngresarPais instancia;
     ...
     */
    public static JFIngresarPais getInstancia() {
        if (instancia == null) {
            instancia = new JFIngresarPais();
        }
        return instancia;
    }
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        String nombrePais = txtNombre.getText().trim();
        // Chequeo si el campo nombre no está vacío
        JOptionPane opcion = new JOptionPane();
        opcion.setMessage("¿Seguro que quieres registrar este País?");
        ...
        if (respuesta == JOptionPane.YES_OPTION) {
            if(!nombrePais.isBlank()){
                try {
                    ...
                    paisDTO.setNombre(txtNombre.getText());
                    paisDTO.setEstado(EstadosEnum.ACTIVO);
                    Conexion.rec_pais.registrar(paisDTO);
                ...
                JOptionPane.showMessageDialog(this, "Error en el registro \n Ingrese un nombre para el País.");
            }
        }
    ...
    private void initComponents() {
        ...
        lblCartel.setText("Ingresar País");
